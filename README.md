...
## MongoDB
For warn commands, you must create a MongoDB database. [Use their guide for the most up-to-date guidance.](<https://www.mongodb.com/docs/manual/installation/> "Use their guide for the most up-to-date guidance.")
